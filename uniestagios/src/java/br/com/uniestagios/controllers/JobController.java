        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (flag) {
                case "logar":
                    ...
                    if ("estudante".equals(type)) {
                        ...
                        if (studentResult != null) {
                            ...
                            authDAO.setMSG("<h4 class=\"header center red white-text\"> NOME DE USUARIO OU SENHA INCORRETOS <i class=\"fa fa-frown-o\" aria-hidden=\"true\"></i></h4>");
                            /**
                             * Repassa os valores dos atributos para o objeto
                             * DAO que irá manipular os dados e gravar no banco
                             */
                ...
                case "validateLogin":
                    ...
                    authDAO.setMSG("<h5 class=\"header center red white-text\">HO HOW.. <i class=\"fa fa-frown-o\" aria-hidden=\"true\"></i> <br> VOCÊ NÃO ESTA LOGADO, FAVOR FAZER LOGIN OU PARA REALIZAR UM CADASTRO CLIQUE <a href=\"register_user.jsp\" class=\" black-text\"> AQUI </a> ! </h5> ");
                    request.setAttribute("msg", authDAO.getMSG());
                    request.getRequestDispatcher("login.jsp").
                            forward(request, response);
